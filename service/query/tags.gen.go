...
type ITagDo interface {
	...
	Unscoped() ITagDo
	Create(values ...*Db.Tag) error
	CreateInBatches(values []*Db.Tag, batchSize int) error
	Save(values ...*Db.Tag) error
	First() (*Db.Tag, error)
	Take() (*Db.Tag, error)
	Last() (*Db.Tag, error)
	Find() ([]*Db.Tag, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*Db.Tag, err error)
	FindInBatches(result *[]*Db.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*Db.Tag) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*Db.Tag, error)
	FirstOrCreate() (*Db.Tag, error)
	FindByPage(offset int, limit int) (result []*Db.Tag, count int64, err error)
...
func (t tagDo) Create(values ...*Db.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) CreateInBatches(values []*Db.Tag, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tagDo) Save(values ...*Db.Tag) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tagDo) First() (*Db.Tag, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*Db.Tag), nil
	}
}

func (t tagDo) Take() (*Db.Tag, error) {
...
func (t tagDo) Last() (*Db.Tag, error) {
...
func (t tagDo) Find() ([]*Db.Tag, error) {
	result, err := t.DO.Find()
	return result.([]*Db.Tag), err
}

func (t tagDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*Db.Tag, err error) {
	buf := make([]*Db.Tag, 0, batchSize)
...
func (t tagDo) FindInBatches(result *[]*Db.Tag, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tagDo) FirstOrInit() (*Db.Tag, error) {
...
func (t tagDo) FirstOrCreate() (*Db.Tag, error) {
...
func (t tagDo) FindByPage(offset int, limit int) (result []*Db.Tag, count int64, err error) {
...
func (t tagDo) Delete(models ...*Db.Tag) (result gen.ResultInfo, err error) {

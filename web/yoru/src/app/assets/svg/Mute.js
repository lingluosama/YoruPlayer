export function SvgMute(props){
    
    return (
        <svg t="1739623602823" className={props.className} viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="3784" width={props.w} height={props.h} onClick={props.onClick}>
            <path

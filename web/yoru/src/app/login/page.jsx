...
const Container = () => {
  ...
  return (
    ...
    >
      <div className={`min-h-screen min-w-full flex items-center  justify-center transition-opacity duration-500 ${state.fade ? "rotate-y-0 opacity-100" : "rotate-y-180 opacity-45 visibility-hidden"} transition-transform`}>
        {state.isLoggedIn ? (
